...
tempt, humid = pcc.processReceivedData()
...
# buttonRefresh = tk.Button(master=home, text="Refresh", bg="green", font=tkFont.Font(size=font18), command=pcc.processReceivedData)
...
def catchEventRefresh():
    labelTemptRe["text"], labelHumidRe["text"] = pcc.processReceivedData() 
